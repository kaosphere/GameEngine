...
{
    m_backdropTexture = Utils::make_unique<sf::RenderTexture>();
    m_contentTexture = Utils::make_unique<sf::RenderTexture>();
    m_controlTexture = Utils::make_unique<sf::RenderTexture>();
}
