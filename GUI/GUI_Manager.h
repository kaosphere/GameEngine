...
using GUI_Container = std::map<StateType, GUI_Interfaces>;
using GUI_Events = std::map<StateType, std::vector<GUI_Event>>;
using GUI_Factory = std::map<GUI_ElementType, std::function<GUI_Element*(GUI_Interface*)>>;
